...
%\ohead*{Team 4} % Right header
%\ihead*{Message Logger} % Left header
%\chead*{} % Centre header

%\ofoot*{\pagemark} % Right footer
%\ifoot*{System-Spezifikation – Inspiriert von Standards des Institute of Electrical and Electronics Engineers} % Left footer
%\cfoot*{} % Centre footer
\usepackage{fancyhdr}
\usepackage[lastpage, user]{zref}
\fancyhf{}
\lhead{Systemspezifikation}
\rhead{Team 4}
\lfoot{\today}
